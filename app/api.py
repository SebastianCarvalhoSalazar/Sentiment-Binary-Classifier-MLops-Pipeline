...
app = FastAPI(
    ...
    description="API para clasificación de sentimientos en reseñas de películas",
    version="1.0.0"
)
...
def load_mlflow_model():
    ...
    model_files = [
        ('models/logistic_regression_bayesian.pkl', 'Logistic Regression Bayesian'),
        ('models/xgboost_bayesian_calibrated.pkl', 'XGBoost Bayesian'),
        ('models/random_forest_bayesian.pkl', 'Random Forest Bayesian'),
    ]
    
    for model_path, model_name in model_files:
        if os.path.exists(model_path):
            try:
                if 'bayesian' in model_path:
